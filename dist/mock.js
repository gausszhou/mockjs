...
/***/ (function(module, exports, __webpack_require__) {
	...
	var basicModule = __webpack_require__(6);
	basicModule._random = Random._random;
	...
	module.exports = {
	    ...
	    cfirst: function () {
	        var names = ('王 李 张 刘 陈 杨 赵 黄 周 吴 ' +
	            ...
	            '郝 孔 白 崔 康 毛 邱 秦 江 史 ' +
	            '顾 侯 邵 孟 龙 万 段 雷 钱 汤 ' +
	            '尹 黎 易 常 武 乔 贺 赖 龚 文').split(' ');
	        return this.pick(names);
	    },
	    clast: function () {
	        var names = ('伟 芳 娜 秀英 敏 静 丽 强 磊 军 ' +
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    tld: function () {
	        return this.pick(('com net org edu gov int mil cn ' +
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Diff = {
	    diff: function diff(schema, data, name) {
	        var result = [];
	        if (this.name(schema, data, name, result) &&
